...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_sliders_js__WEBPACK_IMPORTED_MODULE_1__["default"])('.feedback-slider-item', 'horizontal', '.main-prev-btn', '.main-next-btn');
  Object(_modules_sliders_js__WEBPACK_IMPORTED_MODULE_1__["default"])('.main-slider-item', 'vertical');
...
var calc = function calc(size, material, options, promocode, result) {
  ...
  function changePram(event, elem) {
    elem.addEventListener(event, function (e) {
      ...
      Object(_services_requests__WEBPACK_IMPORTED_MODULE_0__["getResource"])('../../assets/pricesChart.json').then(function (res) {
        calcFunc(res);
...
var drop = function drop() {
  // drag *
  // dragend *
  // dragenter - объект над drop area 
  // dragexit *
  // dragleave - наш объукт за пределами droparea
  // dragover - объект зависает над droparea
  // dragstart *
  // drop - наш объект отправлен в droparea 
...
var forms = function forms() {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      var statusImg = document.createElement('img'); // statusImg.style.display = 'block';
...
var mask = function mask(selector) {
  ...
  function createMask(event) {
    var matrix = '+7 (___) ___ __ __',
        i = 0,
        // не позволяет пользователю удалить цифры из матрицы 
  ...
  function showModalByTime(selector, time) {
    setTimeout(function () {
      ...
      document.querySelectorAll('[data-modal]').forEach(function (item) {
        // показывается ли модальное окно пользователю на основе computed style
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  var btn = document.querySelector(trigger); // cards = document.querySelectorAll(styles)
  //add more examples by getting examples on load and revealing them by changing dsiplay style
  // cards.forEach( card => {
  ...
  btn.addEventListener('click', function () {
    ...
    }) //добавить функционал вывода ошибки пользователю 
    .catch(function (error) {
      return console.log(error);
    });
    this.remove();
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          throw new Error("Could not fetch ".concat(url, " data, status ").concat(res.status));
